...
def work_with_file(files, type_of_file, n, top, code_page):
    file_1 = Newsfile('' + files[0] + '.' + type_of_file, type_of_file, code_page[0])
    file_2 = Newsfile(files[1] + '.' + type_of_file, type_of_file, code_page[1])
    file_3 = Newsfile(files[2] + '.' + type_of_file, type_of_file, code_page[2])
    file_4 = Newsfile(files[3] + '.' + type_of_file, type_of_file, code_page[3])
...
def main():
    ...
    # # Файлы формата json.
    work_with_file(files, 'json', n, top, ['utf-8', 'KOI8-R', 'ISO-8859-5', 'windows-1251'])
